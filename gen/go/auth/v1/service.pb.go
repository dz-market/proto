...
const file_auth_v1_service_proto_rawDesc = "" +
	...
	"\x14\x1a\x12.google.rpc.Status\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/api/v1/auth/login\x12\xf9\x03\n" +
	...
	"\bAuth API\x12RAuthentication: credentials, JWT access tokens and rotating opaque refresh tokens.2\x02v12\x10application/json:\x10application/jsonR7\n" +
	"\x03500\x120\n" +
	"\x16Internal server error.\x12\x16\n" +
	"\x14\x1a\x12.google.rpc.StatusZM\n" +
	"K\n" +
	"\n" +
	"BearerAuth\x12=\b\x02\x12(JWT access token. Format: Bearer {token}\x1a\rAuthorization \x02b\beditionsp\xe9\az\x1cgoogle/api/annotations.protoz.protoc-gen-openapiv2/options/annotations.proto"
